...
targets = [
    ...
    ("mlkem_core_stage_encrypt_noise",
     "encrypt PRF/CBD plus lazy r NTT"),
    ("mlkem_core_stage_encrypt_accum_inv",
     "K=3 accumulation plus inverse-add"),
    ("mlkem_core_stage_encrypt_inv_add_u_raw",
     "production-adjacent three-u inverse-add diagnostic"),
    ("mlkem_core_stage_encrypt_inv_add_u_full3_pragma_raw",
     "three-polynomial inverse-add scheduling remains diagnostic only"),
    ("mlkem_core_stage_encrypt_inv_add_u_tail_final_raw",
     "tail/final chain is the larger inverse-add subtarget"),
    ("mlkem_core_stage_encrypt_inv_add_u_tail_final3_pragma_raw",
     "level-by-level three-u tail/final batching is rejected"),
    ("mlkem_core_stage_sample_ntt4_keccak_store3",
     "common x4 sampler Keccak/state/store cost"),
    ("mlkem_core_stage_sample_ntt4_init_only",
     "x4 sampler initialization is too small to be the next target"),
    ("mlkem_core_stage_sample_ntt4_keccak3_only",
     "common x4 sampler Keccak permutations dominate stream setup"),
    ("mlkem_core_stage_sample_ntt4_parse_504",
     "parser bookkeeping is not the main sampler cost"),
    ("mlkem_core_stage_sample_ntt4_common3_step",
     "common first three-rate sampler step including parse/bookkeeping"),
