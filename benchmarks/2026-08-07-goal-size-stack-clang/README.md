...
and stack matrix at commit `e43c9ab` (algorithm commit `a03a486`). Each of the
...
| native | mlkem-native | 103,485 B | 51,200 B | +52,285 B | FAIL |
...
| AVX2-only | mlkem-native | 65,019 B | 51,279 B | +13,740 B | FAIL |
...
are mlkem-native at 51,200 bytes for native and OpenSSL at 45,049 bytes for
