...
must change x4 Keccak/state/parser dataflow; seed-load hoisting, lane regrouping,
and scalar refill tweaks are already closed by their recorded A/B results.
